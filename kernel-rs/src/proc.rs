...
impl proc_0 {
    ...
    pub const fn zeroed() -> Self {
        Self {
            ...
            state: UNUSED,
            parent: ptr::null_mut(),
            chan: ptr::null_mut() as *const libc::c_void as *mut libc::c_void,
            killed: 0,
            xstate: 0,
            pid: 0,
            kstack: 0,
            sz: 0,
            pagetable: ptr::null_mut() as *const u64 as *mut u64,
            tf: ptr::null_mut() as *const trapframe as *mut trapframe,
            context: Context::zeroed(),
            ofile: [ptr::null_mut() as *const File as *mut File; 16],
            cwd: ptr::null_mut() as *const Inode as *mut Inode,
            name: [0; 16],
        }
    }
}
