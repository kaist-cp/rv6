...
pub unsafe fn argaddr(mut n: i32, mut ip: *mut u64) -> i32 {
    *ip = argraw(n);
    0
}
...
static mut syscalls: [Option<unsafe fn() -> u64>; 22] = unsafe {
    [
        None,
        Some(sys_fork as unsafe fn() -> u64),
        Some(sys_exit as unsafe fn() -> u64),
        Some(sys_wait as unsafe fn() -> u64),
        Some(sys_pipe as unsafe fn() -> u64),
        Some(sys_read as unsafe fn() -> u64),
        Some(sys_kill as unsafe fn() -> u64),
        Some(sys_exec as unsafe fn() -> u64),
        Some(sys_fstat as unsafe fn() -> u64),
        Some(sys_chdir as unsafe fn() -> u64),
        Some(sys_dup as unsafe fn() -> u64),
        Some(sys_getpid as unsafe fn() -> u64),
        Some(sys_sbrk as unsafe fn() -> u64),
        Some(sys_sleep as unsafe fn() -> u64),
        Some(sys_uptime as unsafe fn() -> u64),
        Some(sys_open as unsafe fn() -> u64),
        Some(sys_write as unsafe fn() -> u64),
        Some(sys_mknod as unsafe fn() -> u64),
        Some(sys_unlink as unsafe fn() -> u64),
        Some(sys_link as unsafe fn() -> u64),
        Some(sys_mkdir as unsafe fn() -> u64),
...
pub unsafe fn syscall() {
    ...
    if num > 0
        && (num as u64)
            < (::core::mem::size_of::<[Option<unsafe fn() -> u64>; 22]>() as u64)
                .wrapping_div(::core::mem::size_of::<Option<unsafe fn() -> u64>>() as u64)
