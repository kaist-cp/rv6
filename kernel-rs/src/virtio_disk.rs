...
const disk_PADDING: usize =
    ::core::mem::size_of::<disk>() - ::core::mem::size_of::<disk_Inner>();
#[derive(Copy, Clone)]
#[repr(C)]
...
static mut disk_global: disk =
    disk(disk_Inner{pages: [0; 8192],
                    ...
                    used_idx: 0,
                    info:
                        [C2RustUnnamed{b: 0 as *const buf as *mut buf,
                                       status: 0,}; 8],
                    vdisk_lock:
                        spinlock{locked: 0,
                                 name:
...
pub unsafe extern "C" fn virtio_disk_init() {
    ...
    initlock(&mut disk_global.0.vdisk_lock,
             b"virtio_disk\x00" as *const u8 as *const libc::c_char as
                 *mut libc::c_char);
    if *((VIRTIO0 + 0 as libc::c_int) as *mut uint32) !=
           0x74726976 as libc::c_int as libc::c_uint ||
           *((VIRTIO0 + 0x4 as libc::c_int) as *mut uint32) !=
               1 as libc::c_int as libc::c_uint ||
           *((VIRTIO0 + 0x8 as libc::c_int) as *mut uint32) !=
               2 as libc::c_int as libc::c_uint ||
           *((VIRTIO0 + 0xc as libc::c_int) as *mut uint32) !=
               0x554d4551 as libc::c_int as libc::c_uint {
        panic(b"could not find virtio disk\x00" as *const u8 as
                  *const libc::c_char as *mut libc::c_char);
    }
    status |= VIRTIO_CONFIG_S_ACKNOWLEDGE as libc::c_uint;
    ::core::ptr::write_volatile((VIRTIO0 + 0x70 as libc::c_int) as
                                    *mut uint32, status);
    status |= VIRTIO_CONFIG_S_DRIVER as libc::c_uint;
    ::core::ptr::write_volatile((VIRTIO0 + 0x70 as libc::c_int) as
                                    *mut uint32, status);
    // negotiate features
    let mut features: uint64 =
        *((VIRTIO0 + 0x10 as libc::c_int) as *mut uint32) as uint64;
    features &= !((1 as libc::c_int) << VIRTIO_BLK_F_RO) as libc::c_ulong;
    features &= !((1 as libc::c_int) << VIRTIO_BLK_F_SCSI) as libc::c_ulong;
    features &=
        !((1 as libc::c_int) << VIRTIO_BLK_F_CONFIG_WCE) as libc::c_ulong;
    features &= !((1 as libc::c_int) << VIRTIO_BLK_F_MQ) as libc::c_ulong;
    features &= !((1 as libc::c_int) << VIRTIO_F_ANY_LAYOUT) as libc::c_ulong;
    features &=
        !((1 as libc::c_int) << VIRTIO_RING_F_EVENT_IDX) as libc::c_ulong;
    features &=
        !((1 as libc::c_int) << VIRTIO_RING_F_INDIRECT_DESC) as libc::c_ulong;
    ::core::ptr::write_volatile((VIRTIO0 + 0x20 as libc::c_int) as
                                    *mut uint32, features as uint32);
    ...
    ::core::ptr::write_volatile((VIRTIO0 + 0x70 as libc::c_int) as
                                    *mut uint32, status);
    ::core::ptr::write_volatile((VIRTIO0 + 0x28 as libc::c_int) as
                                    *mut uint32, PGSIZE as uint32);
    // initialize queue 0.
    ::core::ptr::write_volatile((VIRTIO0 + 0x30 as libc::c_int) as
                                    *mut uint32, 0 as libc::c_int as uint32);
    let mut max: uint32 = *((VIRTIO0 + 0x34 as libc::c_int) as *mut uint32);
    if max == 0 as libc::c_int as libc::c_uint {
        panic(b"virtio disk has no queue 0\x00" as *const u8 as
                  *const libc::c_char as *mut libc::c_char);
    }
    if max < NUM as libc::c_uint {
        panic(b"virtio disk max queue too short\x00" as *const u8 as
                  *const libc::c_char as *mut libc::c_char);
    }
    ::core::ptr::write_volatile((VIRTIO0 + 0x38 as libc::c_int) as
                                    *mut uint32, NUM as uint32);
    memset(disk_global.0.pages.as_mut_ptr() as *mut libc::c_void, 0 as libc::c_int,
           ::core::mem::size_of::<[libc::c_char; 8192]>() as libc::c_ulong as
               uint);
    ::core::ptr::write_volatile((VIRTIO0 + 0x40 as libc::c_int) as
                                    *mut uint32,
                                (disk_global.0.pages.as_mut_ptr() as uint64 >>
                                     PGSHIFT) as uint32);
  ...
  // used = pages + 4096 -- 2 * uint16, then num * vRingUsedElem
    ...
    disk_global.0.avail =
        (disk_global.0.desc as
             *mut libc::c_char).offset((NUM as
                                            libc::c_ulong).wrapping_mul(::core::mem::size_of::<VRingDesc>()
                                                                            as
                                                                            libc::c_ulong)
                                           as isize) as *mut uint16;
    disk_global.0.used =
        disk_global.0.pages.as_mut_ptr().offset(PGSIZE as isize) as *mut UsedArea;
...
unsafe extern "C" fn free_desc(mut i: libc::c_int) {
    if i >= NUM {
        panic(b"virtio_disk_intr 1\x00" as *const u8 as *const libc::c_char as
                  *mut libc::c_char);
    }
    if disk_global.0.free[i as usize] != 0 {
        panic(b"virtio_disk_intr 2\x00" as *const u8 as *const libc::c_char as
                  *mut libc::c_char);
    }
    (*disk_global.0.desc.offset(i as isize)).addr = 0 as libc::c_int as uint64;
    disk_global.0.free[i as usize] = 1 as libc::c_int as libc::c_char;
    wakeup(&mut *disk_global.0.free.as_mut_ptr().offset(0 as libc::c_int as isize) as
...
unsafe extern "C" fn free_chain(mut i: libc::c_int) {
    loop  {
        free_desc(i);
        if !((*disk_global.0.desc.offset(i as isize)).flags as libc::c_int &
                 VRING_DESC_F_NEXT != 0) {
            break ;
        }
    ...
    while i < 3 as libc::c_int {
        *idx.offset(i as isize) = alloc_desc();
        if *idx.offset(i as isize) < 0 as libc::c_int {
            ...
            while j < i { free_desc(*idx.offset(j as isize)); j += 1 }
            return -(1 as libc::c_int)
        }
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn virtio_disk_rw(mut b: *mut buf,
                                        mut write: libc::c_int) {
    let mut sector: uint64 =
        (*b).blockno.wrapping_mul((BSIZE / 512 as libc::c_int) as
                                      libc::c_uint) as uint64;
  ...
  // the data, one for a 1-byte status result.
    ...
    while !(alloc3_desc(idx.as_mut_ptr()) == 0 as libc::c_int) {
        sleep(&mut *disk_global.0.free.as_mut_ptr().offset(0 as libc::c_int as isize)
                  as *mut libc::c_char as *mut libc::c_void,
              &mut disk_global.0.vdisk_lock);
    }
    // format the three descriptors.
  // qemu's virtio-blk.c reads them.
    let mut buf0: virtio_blk_outhdr =
        virtio_blk_outhdr{type_0: 0,
                          reserved: 0,
                          sector: 0,}; // read the disk
    if write != 0 {
        buf0.type_0 = VIRTIO_BLK_T_OUT as uint32
    } else { buf0.type_0 = VIRTIO_BLK_T_IN as uint32 } // write the disk
    buf0.reserved = 0 as libc::c_int as uint32;
    buf0.sector = sector;
    // buf0 is on a kernel stack, which is not direct mapped,
  // thus the call to kvmpa().
    (*disk_global.0.desc.offset(idx[0 as libc::c_int as usize] as isize)).addr =
        kvmpa(&mut buf0 as *mut virtio_blk_outhdr as
                  uint64); // device writes b->data
    (*disk_global.0.desc.offset(idx[0 as libc::c_int as usize] as isize)).len =
        ::core::mem::size_of::<virtio_blk_outhdr>() as libc::c_ulong as
            uint32; // device reads b->data
    (*disk_global.0.desc.offset(idx[0 as libc::c_int as usize] as isize)).flags =
        VRING_DESC_F_NEXT as uint16; // device writes the status
    (*disk_global.0.desc.offset(idx[0 as libc::c_int as usize] as isize)).next =
        idx[1 as libc::c_int as usize] as uint16;
    (*disk_global.0.desc.offset(idx[1 as libc::c_int as usize] as isize)).addr =
        (*b).data.as_mut_ptr() as uint64;
    (*disk_global.0.desc.offset(idx[1 as libc::c_int as usize] as isize)).len =
        BSIZE as uint32;
    if write != 0 {
        (*disk_global.0.desc.offset(idx[1 as libc::c_int as usize] as isize)).flags =
    ...
    *fresh0 = (*fresh0 as libc::c_int | VRING_DESC_F_NEXT) as uint16;
    (*disk_global.0.desc.offset(idx[1 as libc::c_int as usize] as isize)).next =
        idx[2 as libc::c_int as usize] as uint16;
    disk_global.0.info[idx[0 as libc::c_int as usize] as usize].status =
        0 as libc::c_int as libc::c_char;
    (*disk_global.0.desc.offset(idx[2 as libc::c_int as usize] as isize)).addr =
        &mut (*disk_global.0.info.as_mut_ptr().offset(*idx.as_mut_ptr().offset(0 as
                                                                            libc::c_int
                                                                            as
                                                                            isize)
                                                   as isize)).status as
            *mut libc::c_char as uint64;
    (*disk_global.0.desc.offset(idx[2 as libc::c_int as usize] as isize)).len =
        1 as libc::c_int as uint32;
    (*disk_global.0.desc.offset(idx[2 as libc::c_int as usize] as isize)).flags =
        VRING_DESC_F_WRITE as uint16;
    (*disk_global.0.desc.offset(idx[2 as libc::c_int as usize] as isize)).next =
        0 as libc::c_int as uint16;
  ...
  // we only tell device the first index in our chain of descriptors.
    *disk_global.0.avail.offset((2 as libc::c_int +
                              *disk_global.0.avail.offset(1 as libc::c_int as isize)
                                  as libc::c_int % NUM) as isize) =
        idx[0 as libc::c_int as usize] as uint16; // value is queue number
    ::core::intrinsics::atomic_fence();
    *disk_global.0.avail.offset(1 as libc::c_int as isize) =
        (*disk_global.0.avail.offset(1 as libc::c_int as isize) as libc::c_int +
             1 as libc::c_int) as uint16;
    ::core::ptr::write_volatile((VIRTIO0 + 0x50 as libc::c_int) as
                                    *mut uint32, 0 as libc::c_int as uint32);
    // Wait for virtio_disk_intr() to say request has finished.
    while (*b).disk == 1 as libc::c_int {
        sleep(b as *mut libc::c_void,
              &mut disk_global.0.vdisk_lock); // disk is done with buf
    }
    disk_global.0.info[idx[0 as libc::c_int as usize] as usize].b = 0 as *mut buf;
...
pub unsafe extern "C" fn virtio_disk_intr() {
    ...
    while disk_global.0.used_idx as libc::c_int % NUM !=
        ...
        if disk_global.0.info[id as usize].status as libc::c_int != 0 as libc::c_int
           {
            panic(b"virtio_disk_intr status\x00" as *const u8 as
                      *const libc::c_char as *mut libc::c_char);
        }
        ...
        disk_global.0.used_idx =
            ((disk_global.0.used_idx as libc::c_int + 1 as libc::c_int) % NUM) as
                uint16
    }
    release(&mut disk_global.0.vdisk_lock);
}
